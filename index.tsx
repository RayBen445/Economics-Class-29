    ...
    const renderMatricManagement = () => (
        <>
            ...
            <div className="card">
                ...
                <div className="admin-toolbar">
                    <input type="text" placeholder="e.g., 2024000000" value={newMatric} onChange={e => setNewMatric(e.target.value)} />
